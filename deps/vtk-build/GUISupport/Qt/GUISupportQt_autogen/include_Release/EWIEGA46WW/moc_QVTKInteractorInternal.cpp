...
template <> constexpr inline auto QVTKInteractorInternal::qt_create_metaobjectdata<qt_meta_tag_ZN22QVTKInteractorInternalE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<QVTKInteractorInternal, qt_meta_tag_ZN22QVTKInteractorInternalE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QVTKInteractorInternal::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22QVTKInteractorInternalE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22QVTKInteractorInternalE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN22QVTKInteractorInternalE_t>.metaTypes,
    nullptr
} };
...
void *QVTKInteractorInternal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22QVTKInteractorInternalE_t>.strings))
