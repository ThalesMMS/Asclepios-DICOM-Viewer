...
#include "../../../../../../vtk/GUISupport/QtQuick/QQuickVTKRenderItem.h"
...
template <> constexpr inline auto QQuickVTKRenderItem::qt_create_metaobjectdata<qt_meta_tag_ZN19QQuickVTKRenderItemE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QQuickWindow *)>(6, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 7, 8 },
        }}),
    };
    QtMocHelpers::UintData qt_properties {
        // property 'renderWindow'
        QtMocHelpers::PropertyData<QQuickVTKRenderWindow*>(9, 0x80000000 | 10, QMC::DefaultPropertyFlags | QMC::Writable | QMC::EnumOrFlag | QMC::StdCppSet),
    };
    QtMocHelpers::UintData qt_enums {
    };
    return QtMocHelpers::metaObjectData<QQuickVTKRenderItem, qt_meta_tag_ZN19QQuickVTKRenderItemE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QQuickVTKRenderItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickItem::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QQuickVTKRenderItemE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QQuickVTKRenderItemE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN19QQuickVTKRenderItemE_t>.metaTypes,
    nullptr
} };
...
void *QQuickVTKRenderItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN19QQuickVTKRenderItemE_t>.strings))
