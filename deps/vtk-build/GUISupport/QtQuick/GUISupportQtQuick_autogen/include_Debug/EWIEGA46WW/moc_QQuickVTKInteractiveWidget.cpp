...
#include "../../../../../../vtk/GUISupport/QtQuick/QQuickVTKInteractiveWidget.h"
...
template <> constexpr inline auto QQuickVTKInteractiveWidget::qt_create_metaobjectdata<qt_meta_tag_ZN26QQuickVTKInteractiveWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'sync'
        QtMocHelpers::SlotData<void(vtkRenderer *)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<QQuickVTKInteractiveWidget, qt_meta_tag_ZN26QQuickVTKInteractiveWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QQuickVTKInteractiveWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN26QQuickVTKInteractiveWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN26QQuickVTKInteractiveWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN26QQuickVTKInteractiveWidgetE_t>.metaTypes,
    nullptr
} };
...
void QQuickVTKInteractiveWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QQuickVTKInteractiveWidget::*)(bool )>(_a, &QQuickVTKInteractiveWidget::enabledChanged, 0))
            return;
    }
...
void *QQuickVTKInteractiveWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN26QQuickVTKInteractiveWidgetE_t>.strings))
