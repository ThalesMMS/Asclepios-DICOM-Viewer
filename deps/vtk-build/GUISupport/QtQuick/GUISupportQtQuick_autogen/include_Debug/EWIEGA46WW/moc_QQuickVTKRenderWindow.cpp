...
#include "../../../../../../vtk/GUISupport/QtQuick/QQuickVTKRenderWindow.h"
...
template <> constexpr inline auto QQuickVTKRenderWindow::qt_create_metaobjectdata<qt_meta_tag_ZN21QQuickVTKRenderWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QQuickWindow *)>(8, 2, QMC::AccessProtected, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
    };
    ...
    return QtMocHelpers::metaObjectData<QQuickVTKRenderWindow, qt_meta_tag_ZN21QQuickVTKRenderWindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QQuickVTKRenderWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QQuickItem::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21QQuickVTKRenderWindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21QQuickVTKRenderWindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN21QQuickVTKRenderWindowE_t>.metaTypes,
    nullptr
} };
...
void *QQuickVTKRenderWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN21QQuickVTKRenderWindowE_t>.strings))
