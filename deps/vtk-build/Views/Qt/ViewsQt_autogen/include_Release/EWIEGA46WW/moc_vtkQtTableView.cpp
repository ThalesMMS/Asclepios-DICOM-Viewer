...
template <> constexpr inline auto vtkQtTableView::qt_create_metaobjectdata<qt_meta_tag_ZN14vtkQtTableViewE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<vtkQtTableView, qt_meta_tag_ZN14vtkQtTableViewE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject vtkQtTableView::staticMetaObject = { {
    QMetaObject::SuperData::link<vtkQtView::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14vtkQtTableViewE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14vtkQtTableViewE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14vtkQtTableViewE_t>.metaTypes,
    nullptr
} };
...
void *vtkQtTableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14vtkQtTableViewE_t>.strings))
