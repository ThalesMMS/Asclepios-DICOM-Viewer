...
int TestOBJPolyDataWriter(int, char*[]);
int TestOBJReaderComments(int, char*[]);
int TestOBJReaderGroups(int, char*[]);
int TestOBJReaderMaterials(int, char*[]);
int TestOBJReaderMultiTexture(int, char*[]);
int TestOBJReaderNormalsTCoords(int, char*[]);
int TestOBJReaderRelative(int, char*[]);
int TestOBJReaderSingleTexture(int, char*[]);
...
int TestTecplotReader2(int, char*[]);
