...
int TestMultiBlockXMLIOWithPartialArrays(int, char*[]);
...
int TestXMLHyperTreeGridIO(int, char*[]);
int TestXMLMappedUnstructuredGridIO(int, char*[]);
int TestXMLToString(int, char*[]);
int TestXMLUnstructuredGridReader(int, char*[]);
int TestXMLWriterWithDataArrayFallback(int, char*[]);
int TestXMLWriteRead(int, char*[]);
int TestXMLCompositeDataReaderDistribution(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "TestMultiBlockXMLIOWithPartialArrays",
    TestMultiBlockXMLIOWithPartialArrays
  },
  {
  ...
  {
    "TestXMLHyperTreeGridIO",
    TestXMLHyperTreeGridIO
  },
  {
    "TestXMLMappedUnstructuredGridIO",
    TestXMLMappedUnstructuredGridIO
  },
  {
    "TestXMLToString",
  ...
  {
    "TestXMLCompositeDataReaderDistribution",
    TestXMLCompositeDataReaderDistribution
  },
  {
