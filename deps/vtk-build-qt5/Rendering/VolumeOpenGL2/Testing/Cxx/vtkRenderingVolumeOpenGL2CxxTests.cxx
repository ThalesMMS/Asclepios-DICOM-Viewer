...
int TestGPURayCastDepthPeelingBoxWidget(int, char*[]);
int TestGPURayCastDepthPeelingBlendModes(int, char*[]);
int TestGPURayCastDepthPeelingClip(int, char*[]);
int TestGPURayCastDepthPeelingOpaque(int, char*[]);
int TestGPURayCastDepthPeelingTransVol(int, char*[]);
int TestGPURayCastDepthPeelingTransparentPolyData(int, char*[]);
int TestGPURayCastIsosurface(int, char*[]);
int TestGPURayCastJittering(int, char*[]);
int TestGPURayCastTextureStreaming(int, char*[]);
int TestGPURayCastTextureStreamingMask(int, char*[]);
int TestGPURayCastToggleJittering(int, char*[]);
int TestGPURayCastUserShader(int, char*[]);
int TestGPURayCastUserShader2(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "TestGPURayCastDepthPeelingBoxWidget",
    TestGPURayCastDepthPeelingBoxWidget
  },
  {
  ...
  {
    "TestGPURayCastDepthPeelingClip",
    TestGPURayCastDepthPeelingClip
  },
  {
  ...
  {
    "TestGPURayCastDepthPeelingTransparentPolyData",
    TestGPURayCastDepthPeelingTransparentPolyData
  },
  {
    "TestGPURayCastIsosurface",
    TestGPURayCastIsosurface
  },
  {
  ...
  {
    "TestGPURayCastTextureStreamingMask",
    TestGPURayCastTextureStreamingMask
  },
  {
    "TestGPURayCastToggleJittering",
    TestGPURayCastToggleJittering
  },
  {
