...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtTreeModelAdapter_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject vtkQtTreeModelAdapter::staticMetaObject = { {
    QMetaObject::SuperData::link<vtkQtAbstractModelAdapter::staticMetaObject>(),
    qt_meta_stringdata_vtkQtTreeModelAdapter.data,
    qt_meta_data_vtkQtTreeModelAdapter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *vtkQtTreeModelAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtTreeModelAdapter.stringdata0))
