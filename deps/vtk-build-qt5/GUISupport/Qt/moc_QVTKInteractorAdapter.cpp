...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QVTKInteractorAdapter_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject QVTKInteractorAdapter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QVTKInteractorAdapter.data,
    qt_meta_data_QVTKInteractorAdapter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QVTKInteractorAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QVTKInteractorAdapter.stringdata0))
