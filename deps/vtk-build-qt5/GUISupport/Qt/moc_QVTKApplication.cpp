...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QVTKApplication_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject QVTKApplication::staticMetaObject = { {
    QMetaObject::SuperData::link<QApplication::staticMetaObject>(),
    qt_meta_stringdata_QVTKApplication.data,
    qt_meta_data_QVTKApplication,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QVTKApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QVTKApplication.stringdata0))
