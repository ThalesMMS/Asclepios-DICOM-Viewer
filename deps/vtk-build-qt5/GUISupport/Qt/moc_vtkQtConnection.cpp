...
void vtkQtConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (vtkQtConnection::*)(vtkObject * , unsigned long , void * , void * , vtkCommand * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&vtkQtConnection::EmitExecute)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject vtkQtConnection::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_vtkQtConnection.data,
    qt_meta_data_vtkQtConnection,
    qt_static_metacall,
    nullptr,
    nullptr
} };
