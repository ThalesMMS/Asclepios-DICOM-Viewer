...
int TestQtDebugLeaksView(int, char*[]);
int TestQtTableModelAdapter(int, char*[]);
int TestQtTreeModelAdapter(int, char*[]);
int TestQVTKOpenGLNativeWidgetPicking(int, char*[]);
int TestQVTKOpenGLWidgetPicking(int, char*[]);
int TestQVTKOpenGLNativeWidgetSwapWindows(int, char*[]);
int TestQVTKOpenGLWidgetSwapWindows(int, char*[]);
int TestQVTKOpenGLNativeWidget(int, char*[]);
int TestQVTKOpenGLWidget(int, char*[]);
int TestQVTKOpenGLNativeWidgetWithDisabledInteractor(int, char*[]);
int TestQVTKOpenGLNativeWidgetWithMSAA(int, char*[]);
int TestQVTKOpenGLWidgetWithMSAA(int, char*[]);
int TestWin32QVTKWidget(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
    {
    "TestQtDebugLeaksView",
    TestQtDebugLeaksView
  },
  {
    "TestQtTableModelAdapter",
    TestQtTableModelAdapter
  },
  {
    "TestQtTreeModelAdapter",
    TestQtTreeModelAdapter
  },
  {
    "TestQVTKOpenGLNativeWidgetPicking",
    TestQVTKOpenGLNativeWidgetPicking
  },
  {
    "TestQVTKOpenGLWidgetPicking",
    TestQVTKOpenGLWidgetPicking
  },
  {
    "TestQVTKOpenGLNativeWidgetSwapWindows",
    TestQVTKOpenGLNativeWidgetSwapWindows
  },
  {
    "TestQVTKOpenGLWidgetSwapWindows",
    TestQVTKOpenGLWidgetSwapWindows
  },
  {
    "TestQVTKOpenGLNativeWidget",
    TestQVTKOpenGLNativeWidget
  },
  {
    "TestQVTKOpenGLWidget",
    TestQVTKOpenGLWidget
  },
  {
    "TestQVTKOpenGLNativeWidgetWithDisabledInteractor",
    TestQVTKOpenGLNativeWidgetWithDisabledInteractor
  },
  {
    "TestQVTKOpenGLNativeWidgetWithMSAA",
    TestQVTKOpenGLNativeWidgetWithMSAA
  },
  {
    "TestQVTKOpenGLWidgetWithMSAA",
    TestQVTKOpenGLWidgetWithMSAA
  },
  {
    "TestWin32QVTKWidget",
