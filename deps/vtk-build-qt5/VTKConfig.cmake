...
set(VTK_MODULES_DIR "D:/Asclepios-DICOM-Viewer/deps/vtk-build-qt5/lib/cmake/vtk-8.2/Modules")
...
set(VTK_CMAKE_DIR "D:/Asclepios-DICOM-Viewer/deps/vtk/CMake")
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/Asclepios-DICOM-Viewer/deps/vtk-install-qt5-debug/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/Asclepios-DICOM-Viewer/deps/vtk-install-qt5-debug/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/Asclepios-DICOM-Viewer/deps/vtk-build-qt5/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/Asclepios-DICOM-Viewer/deps/vtk-build-qt5/lib")
  endif ()
endif()
...
# Import VTK targets.
set(VTK_CONFIG_TARGETS_FILE "D:/Asclepios-DICOM-Viewer/deps/vtk-build-qt5/VTKTargets.cmake")
if(NOT TARGET vtkCommonCore)
  include("${VTK_CONFIG_TARGETS_FILE}")
endif()

# Load module interface macros.
include("D:/Asclepios-DICOM-Viewer/deps/vtk/CMake/vtkModuleAPI.cmake")
