...
int TestExtractBlock(int, char*[]);
int TestExtractDataArraysOverTime(int, char*[]);
int TestExtractThresholdsMultiBlock(int, char*[]);
int TestExtraction(int, char*[]);
int TestExtractionExpression(int, char*[]);
int TestExtractRectilinearGrid(int, char*[]);
int TestExtractRows(int, char*[]);
int TestExtractSelectedArraysOverTime(int, char*[]);
...
CM_LOCAL const functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "TestExtractDataArraysOverTime",
    TestExtractDataArraysOverTime
  },
  {
    "TestExtractThresholdsMultiBlock",
    TestExtractThresholdsMultiBlock
  },
  {
    "TestExtraction",
  ...
  {
    "TestExtractSelectedArraysOverTime",
    TestExtractSelectedArraysOverTime
  },
  {
