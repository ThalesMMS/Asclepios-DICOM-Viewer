...
int TestGenericStreamTracer(int, char*[]);
int TestGenericClip(int, char*[]);
int TestGenericContourFilter(int, char*[]);
int TestGenericCutter(int, char*[]);
int TestGenericDataSetTessellator(int, char*[]);
int TestGenericGeometryFilter(int, char*[]);
int TestGenericGlyph3DFilter(int, char*[]);
int TestGenericProbeFilter(int, char*[]);
