...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtTableView_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject vtkQtTableView::staticMetaObject = { {
    QMetaObject::SuperData::link<vtkQtView::staticMetaObject>(),
    qt_meta_stringdata_vtkQtTableView.data,
    qt_meta_data_vtkQtTableView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *vtkQtTableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtTableView.stringdata0))
