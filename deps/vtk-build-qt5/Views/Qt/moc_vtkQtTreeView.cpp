...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtTreeView_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 36, 9), // "collapsed"
QT_MOC_LITERAL(5, 46, 19), // "updatePreviewWidget"
QT_MOC_LITERAL(6, 66, 22), // "slotQtSelectionChanged"
QT_MOC_LITERAL(7, 89, 14) // "QItemSelection"

    },
    "vtkQtTreeView\0expanded\0\0QModelIndex\0"
    "collapsed\0updatePreviewWidget\0"
    "slotQtSelectionChanged\0QItemSelection"
};
...
void vtkQtTreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (vtkQtTreeView::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&vtkQtTreeView::expanded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (vtkQtTreeView::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&vtkQtTreeView::collapsed)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (vtkQtTreeView::*)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&vtkQtTreeView::updatePreviewWidget)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject vtkQtTreeView::staticMetaObject = { {
    QMetaObject::SuperData::link<vtkQtView::staticMetaObject>(),
    qt_meta_stringdata_vtkQtTreeView.data,
    qt_meta_data_vtkQtTreeView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *vtkQtTreeView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtTreeView.stringdata0))
