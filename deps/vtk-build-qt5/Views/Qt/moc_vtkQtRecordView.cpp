...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtRecordView_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject vtkQtRecordView::staticMetaObject = { {
    QMetaObject::SuperData::link<vtkQtView::staticMetaObject>(),
    qt_meta_stringdata_vtkQtRecordView.data,
    qt_meta_data_vtkQtRecordView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *vtkQtRecordView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtRecordView.stringdata0))
