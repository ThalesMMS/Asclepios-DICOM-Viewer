...
int TestCategoricalColors(int, char*[]);
int TestColorSeries(int, char*[]);
int TestColorSeriesLookupTables(int, char*[]);
int TestNamedColors(int, char*[]);
